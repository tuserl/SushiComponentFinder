...
namespace SushiTools
{
  public class SushiComponentFinderWindow : EditorWindow
  {
    ...
    private bool exactSearch;
    private bool includeEnabled = true;
    ...
    [MenuItem("Tools/Sushi Tools/(NEW) Component Finder")]
    public static void ShowWindow()
    {
      GetWindow<SushiComponentFinderWindow>(
          "Sushi Component Finder 🥢🍣. (๑ᵔ⤙ᵔ๑)"
          );
    }
    ...
    private void DrawSearchBar()
    {
      ...
      exactSearch = EditorGUILayout.ToggleLeft(
          "Exact",
          exactSearch,
          GUILayout.Width(70)
          );

      includeEnabled = EditorGUILayout.ToggleLeft(
          "Include Enabled",
          includeEnabled,
          GUILayout.Width(120)
          );

      includeDisabled = EditorGUILayout.ToggleLeft(
          "Include Disabled",
          includeDisabled,
          GUILayout.Width(130)
          );

      selectedOnly = EditorGUILayout.ToggleLeft(
          "Selected Only",
          selectedOnly,
          GUILayout.Width(110)
          );
